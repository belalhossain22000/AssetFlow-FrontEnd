    ...
    <div className="max-w-xs  overflow-hidden shadow-lg m-4 rounded-md">
     ...
     <div className="hover:translate-y-5 transition duration-300">
      ...
      <div className="px-6 py-4 flex justify-between">
        <button onClick={showModal} className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline">
          Sell
        </button>
        <Link to={`shoe-details/${shoe?._id}`} className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline">
          Details
        </Link>
      </div>
     </div>
